...
def chat(name):
    ...
    if re.search(r"profit.*(drop|fall|declin|low)", question) or re.search(r"why.*profit", question):
        ...
        answer = (
            "Profit decline is likely caused by: " + "; ".join(parts) + "."
            if parts else "No significant profit decline drivers detected in current data."
        )
        ...
        answer = (
            f"Top strategies: 1) Deploy {bm} for profit forecasting. "
            "2) Eliminate loss-making sub-categories. "
            "3) Target underperforming regions with localized campaigns. "
            "4) Reduce discounts above 40% threshold."
        )
        ...
        answer = (
            "Run the Risk & Anomaly tab for full analysis. Quick summary: "
            "high discounts (>40%) and sudden monthly profit drops are the key risk signals."
        )
        ...
        answer = (
            f"I can answer questions about profit trends, strategies, models, regions, "
